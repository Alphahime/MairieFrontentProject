...
const Home = () => {
  ...
  <FaHistory className="historique-icon" />
  Historique de la mairie
      ...
      <div className="col image">
        <div className="image-wrapper">
          <img
            src={require('../../assets/images/monsieurlemaire.jpg')}
            alt="Monsieur le Maire de Thiaroye sur Mer"
          />
          <div className="bannermaire">
            <h3>Mr El Mamadou Ndiaye</h3>
          </div>
        </div>
       
<div class="cardreseau">
